/* Things to change:
Choose between playing vs ai or playing with friend locally
Deploy on website with back end
...
var colors = ['#25c7c0', '#48f01b', '#fcad04', '#dc1a1a', '#2a2828'];
...
var Game = {
    ...
    _generateRoundColor: function () {
        var newColor = colors[this.round];
